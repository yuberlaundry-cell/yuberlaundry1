...
export function BookingFlow() {
    ...
    const handlePlaceOrder = () => {
        ...
        // to create a transaction and get an access_code from Paystack.
        ...
        setTimeout(() => {
            ...
            paystack.newTransaction({
                ...
                amount: 4600, // Amount in kobo (R46.00)
                currency: 'ZAR',
                // In a real app, this would be a unique reference generated by your backend
                reference: `yuber_${Math.random().toString(36).substring(7)}`,
                onSuccess: (transaction) => {
                    // API call to your backend to verify transaction
