                ...
                <CardContent className="p-0">
                    ...
                    <div className="grid md:grid-cols-3 gap-4 mb-8 text-center">
                        <Card className="p-4">
                            ...
                            <CardDescription className="text-2xl font-bold">R{invoice.status === 'Paid' ? '0.00' : invoice.amount.toFixed(2)}</CardDescription>
                        </Card>
                         <Card className="p-4">
                        ...
                        <TableBody>
                         ...
                         <TableFooter>
                            <TableRow>
                                ...
                                <TableCell className="text-right">R{invoice.subtotal.toFixed(2)}</TableCell>
                            </TableRow>
                             <TableRow>
                                <TableCell colSpan={3} className="text-right font-medium">Tax (0%)</TableCell>
                                <TableCell className="text-right">R{invoice.tax.toFixed(2)}</TableCell>
                            </TableRow>
